...
create table user (username varchar(100) not null, avatar varchar(255), created_at datetime, email varchar(100) not null, first_name varchar(20) not null, last_name varchar(30), location varchar(255), updated_at datetime, role_id varchar(36), primary key (username));
